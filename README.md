...
Public-zone MCP server for robotized creation, configuration, rollout, operation, and analysis of Altegio Integrations Hub applications. It wraps three deliberately separated surfaces:
...
- Internal, disabled-by-default backoffice: `integrations_hub_backoffice_get_application`, `integrations_hub_backoffice_set_publication`, `integrations_hub_backoffice_set_commercials`, `integrations_hub_backoffice_delete_application`, `integrations_hub_backoffice_list_offers`, `integrations_hub_backoffice_upsert_offer`, `integrations_hub_backoffice_delete_offer`.
